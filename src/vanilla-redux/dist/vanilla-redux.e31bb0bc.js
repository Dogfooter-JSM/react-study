...
var store = (0, _redux.createStore)(reducer); // 스토어의 상태 값 변경 시 호출되는 함수 정의
...
render(); // 구독하기 : 스토어의 상태 값 변경 시 render() 호출 됨 

store.subscribe(render); // 각 엘리먼트 클릭에 따른 store의 reduce 함수 실행
